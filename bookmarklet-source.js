...
(function() {
    ...
    function getStyles() {
        ...
        + '.bm-toolbar button{background:#131b2b;border:1px solid #2a3a50;color:#b0bdd0;padding:10px 16px !important;border-radius:5px;font-size:11px;cursor:pointer}'
        ...
        + '.bm-btn-approve{background:#1e7a35;color:#fff;border:none;padding:12px 28px !important;border-radius:5px;font-size:12px;font-weight:600;cursor:pointer}'
        + '.bm-btn-reject{background:#c53030;color:#fff;border:none;padding:12px 28px !important;border-radius:5px;font-size:12px;font-weight:600;cursor:pointer}'
        ...
        + '.bm-badge-pending{background:#e8893a;color:#fff;padding:2px 10px;border-radius:10px;font-size:10px;font-weight:500}'
        ...
        + '.bm-comments-list{flex:1;overflow-y:auto;padding:10px 14px;min-height:100px}'
