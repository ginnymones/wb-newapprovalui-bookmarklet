...
(function() {
    ...
    function getStyles() {
        ...
        + '.bm-comments-header{display:flex;align-items:center;gap:8px;padding:12px 14px;border-bottom:1px solid #1a2436}'
        ...
        + '.bm-comment-input{display:flex;flex-direction:column;gap:6px;padding:10px 14px;border-top:1px solid #1a2436}'
